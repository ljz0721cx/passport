...
import com.ljz.passport.pojo.OauthToken;
...
public class TokenController {
    ...
    public OauthToken getAccessToken(String code) {
        ...
        sb.append("code=").append(code)
                ...
                .append("&client_id=").append("janle1")
                .append("&client_secret=").append("janleSecret")
                .append("&redirect_uri=").append(URLEncoder.encode((String) "http://client.clouds1000.com:8081/code"));
